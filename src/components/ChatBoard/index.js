...
import { myFirestore, myStorage } from '../../lib/firebase'
import images from '../Themes/Images'
import { AppString } from './../ChatBox/Const'
import {
  message
} from 'antd';
...
export default class ChatMessage extends Component {
  ...
  render() {
    return (
      <div className="viewChatMessage">

        {/* List message */}
        <main className="chatbox-panel__main chatbox-panel__main-second" >
